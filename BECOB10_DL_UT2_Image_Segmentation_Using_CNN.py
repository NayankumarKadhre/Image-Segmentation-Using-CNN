...
X_train = np.zeros((len(train_ids), IMG_HEIGHT, IMG_WIDTH, IMG_CHANNELS), dtypes=np.uint8)
Y_train = np.zeros((len(train_ids), IMG_HEIGHT, IMG_WIDTH, 1), dtypes=np.bool)
...
c5 = tf.keras.layers.Conv2D(265, (3,3), activation='relu', kernel_initializer='he_normal', padding='same')(c5)
